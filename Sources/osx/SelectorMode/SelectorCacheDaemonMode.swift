...
enum SelectorCacheDaemonServer {
    ...
    static func run(
        socketPath: String,
        actionMiddleware: any ActionExecutionMiddleware = NoopActionExecutionMiddleware()) throws
    {
        ...
        while true {
            ...
            do {
                try self.handleClient(fd: clientFD, runner: runner, actionMiddleware: actionMiddleware)
            } catch {
    ...
    private static func handleClient(
        fd: Int32,
        runner: SelectorQueryRunner,
        actionMiddleware: any ActionExecutionMiddleware) throws
    {
        ...
        case .actions:
            ...
            do {
                let output = try OXAExecutor.execute(
                    programSource: actionProgram,
